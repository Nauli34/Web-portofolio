      ...
      <section
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Nauli adhi dinata. I'm a web developer from Tanggerang,I
            have 1 year of experience in front-end web development.
            I really enjoy what I do right now, in my opinion, creating website is not just a job, but also an art that
            has
            aesthetic value
          </p>
